...
//			DownloadInterface downloadInterface = JamendoApplication.getInstance()
...
//	}
    ...
    public static void share(Activity activity, PlaylistEntry entry) {
        String text = activity.getString(R.string.song_recommendation) + ": " + String.format
                ("http://www.jamendo.com/track/%d", entry.getTrack().getId());
